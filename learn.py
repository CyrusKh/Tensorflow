...
def train_neural_network(lr, iteration, train_x, train_y, test_x, test_y, Y_train_numeric, Y_test_numeric, activity_map):
    """
...
def main():
    ...
    print('Train X Data', train_x.shape) #, train_x.columns
    ...
    one_hot_predictions, accuracy_, train_losses, train_accuracies, test_losses, test_accuracies = train_neural_network(lr, iteration, train_x, train_y, test_x, test_y, Y_train_numeric, Y_test_numeric, activity_map)
